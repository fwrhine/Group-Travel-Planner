...
public class Fragment_EntertainmentList extends Fragment {

    private static final String TAG = "EntertainmentList";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_entertainment_list, container, false);
    }
    ...
    public void sendRequest() {
        ...
        String url ="https://maps.googleapis.com/maps/api/place/textsearch/json?query=things+to+do+in+Tokyo&key=" + getString(R.string.api_key);
